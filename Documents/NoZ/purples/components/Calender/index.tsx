/*
 Refrences - https://www.youtube.com/watch?v=9ySmMd5Cjc0
 TailwindUI Calender - https://tailwindui.com/components/application-ui/data-display/calendars
*/
...
export default function Calender({ meetings }: CalenderProps) {
